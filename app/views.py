...
def tasks():
	g.db = connect_db()
	#query db for open tasks --> assign to open_tasks variable
	cur = g.db.execute(
	...
	#query db for closed_tasks --> assign to closed_tasks variable
	cur = g.db.execute(
	...
	g.db.close()
	#open_tasks, and closed_tasks variable will be used to populate their respective lists in the tasks.html script
